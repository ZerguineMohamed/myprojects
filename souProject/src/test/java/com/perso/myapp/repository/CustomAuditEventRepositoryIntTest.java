package com.perso.myapp.repository;

import com.perso.myapp.SouProjectApp;
import com.perso.myapp.config.Constants;
import com.perso.myapp.config.audit.AuditEventConverter;
import com.perso.myapp.domain.PersistentAuditEvent;
...
import static com.perso.myapp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
